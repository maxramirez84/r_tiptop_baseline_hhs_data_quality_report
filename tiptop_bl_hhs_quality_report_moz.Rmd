...
hhs_data$cluster_nhamatanda[hhs_data$district == 1] = 
  rowSums(hhs_data[hhs_data$district == 1, grepl("cluster_", names(hhs_data))], na.rm = T)
hhs_data$cluster_meconta[hhs_data$district == 2] = 
  rowSums(hhs_data[hhs_data$district == 2, grepl("cluster_", names(hhs_data))], na.rm = T)
###
