...
api_token = api_token_moz # TIPTOP HHS Baseline Mozambique
# File
file_prefix = "TIPTOPHHSBaselineMoz"
file_date   ="2018-03-27"
file_time   ="13:33"

# Study area description
study_areas                    = c("Nhamatanda", "Meconta")
study_areas_ids                = c("nhamatanda", "meconta")
sample_size_area_1             = 709
household_to_be_visited_area_1 = 3939
sample_size_area_2             = 477
household_to_be_visited_area_2 = 2650

data_timestamp = dataTimestamp(data_retrieval_mode, file_date, file_time)
```

---
title: "TIPTOP Baseline HHS Data Quality Report: MOZAMBIQUE"
...
# TEMP: Cluster are still not defined so there's no variable cluster_nhamatanda and cluster_meconta
hhs_data$cluster_nhamatanda[hhs_data$district == 1] <- hhs_data$cluster[hhs_data$district == 1]
hhs_data$cluster_meconta[hhs_data$district == 2] <- hhs_data$cluster[hhs_data$district == 2]
###
...
Data collection by [CISM](http://www.manhica.org/).
